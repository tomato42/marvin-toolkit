...
valid_repeated_byte_payload="125 0xff" \
valid_repeated_byte_payload="125 0x01" \
...
--repeat 100000 --verbose \
no_structure no_padding=48 signature_padding=0 \
valid_repeated_byte_payload="253 0xff" \
valid_repeated_byte_payload="253 0x01" \
valid=48 header_only \
no_header_with_payload=48 zero_byte_in_padding="48 4" \
...
--repeat 100000 --verbose \
no_structure no_padding=48 signature_padding=0 \
valid_repeated_byte_payload="509 0xff" \
valid_repeated_byte_payload="509 0x01" \
valid=48 header_only \
no_header_with_payload=48 zero_byte_in_padding="48 4" \
